...
class Quotes(loader.Module):
    ...
    strings = {"name": "yg_quotes",
               "no_reply": "<emoji document_id=5208858619155594626>🙂</emoji> Нет реплая на сообщение",
               "processing": "<emoji document_id=5208858619155594626>🙂</emoji> Обработка…",
               "api_processing": "<emoji document_id=5208858619155594626>🙂</emoji> Ожидание ответа API…",
               "api_error": "<emoji document_id=5208858619155594626>🙂</emoji> Ошибка API: {}",
               "loading_media": "<emoji document_id=5208858619155594626>🙂</emoji> Отправка…",
               "no_args_or_reply": "<emoji document_id=5208858619155594626>🙂</emoji> Нет аргументов или реплая",
               "args_error": "<emoji document_id=5208858619155594626>🙂</emoji> Ошибка разбора аргументов. Запрос: <code>{}</code>",
               "too_many_messages": "<emoji document_id=5208858619155594626>🙂</emoji> Слишком много сообщений. Максимум: <code>{}</code>"}
    ...
    async def qcmd(self, m: Message):
        ...
        try:
            ...
            return await utils.answer(m,f"<emoji document_id=5208858619155594626>🙂</emoji> Ошибка: {e}")
